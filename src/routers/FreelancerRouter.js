...
router.get("/profile", auth, authRole("freelancer"), FreelancerController.GetProfile);
router.put("/profile", auth, authRole("freelancer"), FreelancerController.updateProfile);
